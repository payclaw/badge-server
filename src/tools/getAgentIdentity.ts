// Canonical: badge-server | Synced: 2.3.0 | mcp-server syncs from here
...
function identityFromOAuthToken(
  ...
  return {
    ...
    trust_url: "https://kyalabs.io/trust",
...
export interface IdentityResult {
  ...
  ucpCapable?: boolean;
  /** UCP: merchant requires Badge credential */
...
export function formatIdentityResponse(r: IdentityResult): string {
  ...
  lines.push(
    `  Status:      ACTIVE`,
    `  Trust:       ${r.trust_url || "https://kyalabs.io/trust"}`,
    ``,
